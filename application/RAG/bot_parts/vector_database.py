...
class WeaviateDatabase:
    ...
    def _initialize_collections(self):
        with self._create_client() as client:
            ...
            for lang in LANGS:
                ...
                collections[collection_name] = self._ensure_collection_exists(client, collection_name, lang)

            print("Final collections:", collections.keys())
        return collections

    def _ensure_collection_exists(self, client, collection_name, lang):
        try:
            ...
            if not client.collections.exists(collection_name):
                ...
                self._prepare_document(client, collection_name, lang)
            else:
    ...
    def _prepare_document(self, client, company_name, lang):
        try:
            ...
            self._add_documents(client, company_name, doc_splits, embeddings)
    ...
    def _add_documents(self, client, company_name, documents, embeddings):
        try:
            collection = client.collections.get(company_name)
